...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        public static LogBehaviour logBehaviour {
            ...
            set { _logBehaviour = value; DG.Tweening.Core.Debugger.SetLogPriority(_logBehaviour); }
        }
...
//                DOTween.defaultRecyclable = settings.defaultRecyclable;
            ...
            // Log
            if (DG.Tweening.Core.Debugger.logPriority >= 2) Debugger.Log("DOTween initialization (useSafeMode: " + useSafeMode + ", logBehaviour: " + logBehaviour + ")");
