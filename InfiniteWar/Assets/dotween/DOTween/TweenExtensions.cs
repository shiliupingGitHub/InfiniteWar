...
namespace DG.Tweening
{
    ...
    public static class TweenExtensions
    {
        ...
        {
            if (t == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNullTween(t); return;
            } else if (!t.active) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return;
        ...
        {
            if (t == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNullTween(t); return t;
            } else if (!t.active) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return t;
            } else if (t.isSequenced) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return t;
            }
        ...
        public static void GotoWaypoint(this Tween t, int waypointIndex, bool andPlay = false)
        {
            ...
            if (pathTween == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNonPathTween(t); return;
            }
        ...
        {
            if (!t.active) {
                if (DG.Tweening.Core.Debugger.logPriority > 0) DG.Tweening.Core.Debugger.LogInvalidTween(t);
                return null;
            }
        ...
        {
            if (t == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNullTween(t); return -1;
            } else if (!t.active) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return -1;
            } else if (t.isSequenced) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogInvalidTween(t); return -1;
            }
            ...
            TweenerCore<Vector3, Path, PathOptions> pathTween = t as TweenerCore<Vector3, Path, PathOptions>;
            if (pathTween == null) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogNonPathTween(t); return -1;
            } else if (!pathTween.endValue.isFinalized) {
                if (DG.Tweening.Core.Debugger.logPriority > 1) DG.Tweening.Core.Debugger.LogWarning("The path is not finalized yet"); return -1;
            }
