...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensions
    {
        ...
        public static Tweener DOPitch(this AudioSource target, float endValue, float duration)
        {
            return DOTween.To(
                () =>{
                    return null != target ? target.pitch : endValue;
                }
                , x =>
        ...
        public static Tweener DOShakePosition(this Camera target, float duration, float strength = 3, int vibrato = 10, float randomness = 90)
        {
            return DOTween.Shake(() =>
                {
                    return null != target && null != target.transform ? target.transform.localPosition : Vector3.zero;
                }, x =>
                    {
            ...
            return DOTween.Shake(
                () =>
                    ...
                    x =>
                        ...
                        , duration, strength, vibrato, randomness, false)
        ...
        {
            return DOTween.To(() => { return target != null ? target.position : endValue; },
                x=>
                    {
                        if(null !=target)
        ...
        public static Tweener DOMoveX(this Rigidbody target, float endValue, float duration, bool snapping = false)
        {
            return DOTween.To(() =>
                {
                    return target != null ? target.position : new Vector3(endValue, 0, 0);
                }, x=>
                    {
                        if (null != target)
                            target.MovePosition(x);
        ...
        public static Tweener DOMoveY(this Rigidbody target, float endValue, float duration, bool snapping = false)
        {
            return DOTween.To(() =>
                ...
                {
                    return null != target ? target.position : new Vector3(0, endValue, 0);
                }, x=>
                    {
                        if (null != target)
                            target.MovePosition(x);
        ...
        public static Tweener DOMoveZ(this Rigidbody target, float endValue, float duration, bool snapping = false)
        {
            return DOTween.To(() => 
                {
                    return null != target ?
                        target.position : new Vector3(0, 0, endValue);
                },
                x=>
                    {
                        if(null != target)
        ...
        public static Tweener DORotate(this Rigidbody target, Vector3 endValue, float duration, RotateMode mode = RotateMode.Fast)
        {
            TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DOTween.To(() =>
                {
                    return null != target ?
                        target.rotation : Quaternion.Euler(endValue);
                },
                x=>
                    {
                        if (null != target)
        ...
        public static Tweener DOLookAt(this Rigidbody target, Vector3 towards, float duration, AxisConstraint axisConstraint = AxisConstraint.None, Vector3? up = null)
        {
            TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DOTween.To(() =>
                {
                    return target != null ? target.rotation : Quaternion.Euler(towards);
                }, x=>
                    {
                        if (null != target)
                            target.MoveRotation(x);
        ...
        public static Tweener DOMoveX(this Transform target, float endValue, float duration, bool snapping = false)
        {
            return DOTween.To(() => 
                {
                    return null != target ? target.position : new Vector3(endValue, 0, 0);
                }, x =>
                    {
                        if (null != target)
                            target.position = x;
        ...
        {
            return DOTween.To(() => null != target? target.position:new Vector3(0, 0, endValue), x =>
                {
                    if (null != target)
                        target.position = x;
                }, new Vector3(0, 0, endValue), duration)
        ...
        {
            return DOTween.To(() =>null!= target? target.localPosition:endValue, x =>
                {
                    if (null != target)
        ...
        public static Tweener DOLocalMoveX(this Transform target, float endValue, float duration, bool snapping = false)
        {
            return DOTween.To(() =>
                {
                    return null != target ? target.localPosition : new Vector3(endValue, 0, 0);
                }, x =>
                    {
                        if (null != target)
                            target.localPosition = x;
        ...
        {
            return DOTween.To(() =>
                null != target ? target.localPosition : new Vector3(0, endValue, 0), x =>
                    {
                        if (null != target)
                            target.localPosition = x;
                    }, new Vector3(0, endValue, 0), duration)
        ...
        {
            return DOTween.To(() => null != target ? target.localPosition : new Vector3(0, 0, endValue), x =>
                {
                    if(null != target)
                     target.localPosition = x;
                }, new Vector3(0, 0, endValue), duration)
        ...
        public static Tweener DORotate(this Transform target, Vector3 endValue, float duration, RotateMode mode = RotateMode.Fast)
        {
            TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DOTween.To(() =>
                {
                    return null != target ? target.rotation : Quaternion.Euler(endValue);
                }, x =>
                    {
                        if(null != target)
                        target.rotation = x;
        ...
        {
            TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DOTween.To(() =>null!=target? target.localRotation:Quaternion.Euler(endValue), x =>
                {
                    if (null != target)
        ...
        {
            return DOTween.To(() => null != target ? target.localScale : endValue, x =>
                {
                    if(null != target)
                    target.localScale = x;
                }, endValue, duration).SetTarget(target);
        ...
        {
            return DOTween.To(() => null != target ? target.localScale : new Vector3(endValue, 0, 0), x =>
                {
                    if(null != target)
                    target.localScale = x;
                }, new Vector3(endValue, 0, 0), duration)
        ...
        {
            return DOTween.To(() => null != target ? target.localScale : new Vector3(0, endValue, 0), x =>
                {
                    if(null != target)
                        target.localScale = x;
                }, new Vector3(0, endValue, 0), duration)
        ...
        {
            return DOTween.To(() => null != target ? target.localScale : new Vector3(0, 0, endValue), x =>
                {
                    if(null != target)
                         target.localScale = x;
                }, new Vector3(0, 0, endValue), duration)
        ...
        {
            TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DOTween.To(() => null != target ? target.rotation : Quaternion.Euler(towards), x =>
                {
                    if(null != target)
                        target.rotation = x;
                }, towards, duration)
        ...
        {
            return DOTween.Punch(() => null != target ? target.localPosition : punch, x =>
                {
                    if(null != target)
                     target.localPosition = x;
        ...
        {
            return DOTween.Punch(() => null!= target?target.localScale:punch, x => 
                {
                    if(null != target)
                        target.localScale = x;
                }, punch, duration, vibrato, elasticity)
        ...
        {
            return DOTween.Punch(() => null!= target?target.localEulerAngles:punch, x => 
                {
                    if (null != target)
        ...
        {
            return DOTween.Shake(() => null !=target?
                target.localPosition:Vector3.zero, x => 
                    {
                        if(null != target)
                        target.localPosition = x;
                    }, duration, strength, vibrato, randomness, false)
        ...
        {
            return DOTween.Shake(() => null != target ? target.localPosition : Vector3.zero, x =>
                {
                    if(null != target)
                        target.localPosition = x;
                }, duration, strength, vibrato, randomness)
        ...
        {
            return DOTween.Shake(() =>null!=target? target.localEulerAngles:Vector3.zero,
                x => 
                    {
                        if(null != target)
                             target.localRotation = Quaternion.Euler(x);
        ...
        {
            return DOTween.Shake(() => null != target ? target.localScale : Vector3.zero, x =>
                {
                    if(null != target)
                        target.localScale = x;
                }, duration, strength, vibrato, randomness, false)
        ...
        )
        {
            ...
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To(PathPlugin.Get(), () => null != target ? target.position : Vector3.zero, x =>
                {
                    if(null != target)
                    target.position = x;
        ...
        {
            if (resolution < 1) resolution = 1;
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To(PathPlugin.Get(), () =>null!=target? target.localPosition:Vector3.zero, x =>
                {
                    if(null !=target)
                        target.localPosition = x;
                }, new Path(pathType, path, resolution, gizmoColor), duration)
        ...
        {
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To(PathPlugin.Get(), () => null != target ? target.position : Vector3.zero,
                x =>
                {
                    if(null != target)
                        target.position = x;
