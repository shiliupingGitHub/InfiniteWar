...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensions43
    {
        ...
        {
            return DOTween.To(() => null != target ? target.color : endValue, x =>
                {
                    if(null != target)
                        target.color = x;
        ...
        {
            return DOTween.ToAlpha(() => null != target ? target.color : Color.white, x =>
                {
                    if(null!=target)
                        target.color = x;
                }, endValue, duration)
        ...
        {
            return DOTween.To(() => null!=target?target.position:endValue, 
                x=>
                    {
                        if(null != target)
        ...
        {
            return DOTween.To(() => null != target ? target.position : new Vector2(endValue, 0), x=>
                {
                    if (null != target)
                        target.MovePosition(x);
        ...
        {
            return DOTween.To(() => null != target ? target.position : new Vector2(0, endValue), x =>
                {
                    if(null != target)
                    target.MovePosition(x);
        ...
        {
            return DOTween.To(() => null != target ? target.rotation : endValue, x =>
                {
                    if(null != target)
